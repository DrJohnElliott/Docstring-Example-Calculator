...
'''Provide several sample math functions

This module allows the user to make several mathmatical calculations

Examples:
    >>> from calculator import calculations
    >>> calculations.add(4.0, 2.0)
    6.0
    >>> from calculator.calculations import divide
    >>> divide(4.0, 2)
    2.0

The module contains the following funcions
...
def multiply(a: Union[float, int], b: Union[float, int]) -> float:
    """Compute and return the product of two numbers.
            ...
            Args:
                a : A number representing the multiplican  in the multiplication.
...
def divide(a: Union[float, int], b: Union[float, int]) -> float:
    """Compute and return the quotient of two numbers.
                ...
                Args:
                    a : A number representing the dividiend  in the division.
                    b : A number representing the devisor in the division.
                Returns:
